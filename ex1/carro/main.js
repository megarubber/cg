...
const ve = [];
ve.push(
  ...rectangle(-0.8, -0.5, 1.6, 0.5),
  ...rectangle(-0.4, 0.0, 0.8, 0.5),
  ...rectangle(0, 0, 0.35, 0.4),
  ...rectangle(-0.3, 0, 0.2, 0.4),
  ...circle(-0.4, -0.5),
  ...circle(0.4, -0.5),
);
...
const rectangleChassisColors = generateColorsRectangle(1, 0, 0);
const rectangleWindowColors = generateColorsRectangle(0, 1, 1);
const colorsBuffer = gl.createBuffer();
const l = generateColors(1, 0.7, 0.7);
const colorLocation = gl.getAttribLocation(program, "aColors");
const colors = new Float32Array([
  ...rectangleChassisColors,
  ...rectangleChassisColors,
  ...rectangleWindowColors,
  ...rectangleWindowColors,
  ...circleColors,
  ...circleColors,
]);
...
for(let i = 0; i < 2; i++)
  gl.drawArrays(gl.TRIANGLE_FAN, i * numberElements + 4 * offset, numberElements);
